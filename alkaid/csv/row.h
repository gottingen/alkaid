...
#pragma endregion CSVField::get Specializations
     ...
     *
     */
    inline CSVField CSVRow::operator[](size_t n) const {
     ...
     */
    inline CSVField CSVRow::operator[](const std::string &col_name) const {
    ...
    inline CSVRow::operator std::vector<std::string>() const {
    ...
    inline std::string_view CSVRow::get_field(size_t index) const {
        ...
        auto field_str = std::string_view(this->data->data).substr(this->data_start + field.start);
    ...
    inline bool CSVField::try_parse_hex(int &parsedValue) {
...
/** Return an iterator pointing to the first field. */
    inline CSVRow::iterator CSVRow::begin() const {
 ...
 */
    inline CSVRow::iterator CSVRow::end() const noexcept {
        return CSVRow::iterator(this, (int) this->size());
    }

    inline CSVRow::reverse_iterator CSVRow::rbegin() const noexcept {
        return std::reverse_iterator<CSVRow::iterator>(this->end());
    }

    inline CSVRow::reverse_iterator CSVRow::rend() const {
        return std::reverse_iterator<CSVRow::iterator>(this->begin());
    }

    inline CSVRow::iterator::iterator(const CSVRow *_reader, int _i)
            : daddy(_reader), i(_i) {
    ...
    inline CSVRow::iterator::reference CSVRow::iterator::operator*() const {
        return *(this->field.get());
    }

    inline CSVRow::iterator::pointer CSVRow::iterator::operator->() const {
        return this->field;
    }

    inline CSVRow::iterator &CSVRow::iterator::operator++() {
    ...
    inline CSVRow::iterator CSVRow::iterator::operator++(int) {
    ...
    inline CSVRow::iterator CSVRow::iterator::operator+(difference_type n) const {
...
inline std::ostream &operator<<(std::ostream &os, alkaid::CSVField const &value) {
    os << std::string(value);
    return os;
}
